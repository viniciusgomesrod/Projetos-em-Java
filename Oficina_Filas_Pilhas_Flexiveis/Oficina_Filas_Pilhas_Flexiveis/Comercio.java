...
public class Comercio {
    ...
    */
    ...
    public static void finalizarPedido(Pedido pedido) {
        ...
        for(Celula <T> i = topo; i!= fundo; i = i.getProximo()) {
	...
	/* public static void finalizarPedido(Pedido pedido) {
        if (pedido != null && !pedido.estaVazio()) {
            ...
            System.out.println("Pedido vazio. Nada foi finalizado.");
        }
    }
    */
    ...
    public static void main(String[] args) {
        ...
        nomeArquivoDados = "D:/users/1526526/Downloads/Oficina_Filas_Pilhas_Flexiveis/Oficina_Filas_Pilhas_Flexiveis/produtos.txt";
